...
return c.prototype.update=function(){
	(this.x>this.canvas.width||this.x<-20)&&(this.velocity.x=-this.velocity.x),
	(this.y>this.canvas.height||this.y<-20)&&(this.velocity.y=-this.velocity.y),
	...
	c.prototype.h=function(){
		...
		this.g.fill()},
		b=function(a,b){this.i=a,this.i.size={width:this.i.offsetWidth,height:this.i.offsetHeight},
		b=void 0!==b?b:{},
		this.options={
				...
				!1;this.l(this.k,{
					...
					window.addEventListener("resize",function(){
						return this.i.offsetWidth===this.i.size.width&&this.i.offsetHeight===this.i.size.height?!1:(
							...
							clearTimeout(this.m),
							void(this.m=setTimeout(function(){this.o=[];for(var a=0;a<this.canvas.width*this.canvas.height/this.options.density;a++)
								this.o.push(new c(this));
								this.options.interactive&&this.o.push(this.p),
								requestAnimationFrame(this.update.bind(this))}.bind(this),500)))}.bind(this)),
								this.o=[];
								for(var a=0;a<this.canvas.width*this.canvas.height/this.options.density;a++)this.o.push(new c(this));
									...
									this.canvas.addEventListener("mousemove",function(a){
									    //close the gap on the tiop of the mouse and the creator
										this.p.x=a.clientX-this.canvas.offsetLeft-769,
...
for(var b=this.o.length-1;b>a;b--){
	...
	this.g.lineWidth=.7,
	this.g.moveTo(this.o[a].x,this.o[a].y),this.g.lineTo(this.o[b].x,this.o[b].y),
	this.g.stroke())
	}
...
var canvasDiv = document.getElementById('content');
var options = {
  particleColor: '#8D8D8D',
  background: '#ffffff',
  interactive: true,
  speed: 'medium',
  density: 'high'
